...
//                com.android.internal.R.bool.config_automatic_brightness_available);
    ...
    public void updateState(Preference preference) {
         ...
         *@{
         */
        new TouchLightTimeoutPreferenceController(mContext).setTouchLightTimeoutEnabled(!(brightnessMode != SCREEN_BRIGHTNESS_MODE_MANUAL));
        /*@}*/
    }
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
         ...
         *@{
         */
        new TouchLightTimeoutPreferenceController(mContext).setTouchLightTimeoutEnabled(!auto);
        /*@}*/
