...
public class AppButtonsPreferenceController extends AbstractPreferenceController implements
    ...
    /* SPRD: 737412, add whilte list for can not kill app @{ */
    ...
    public AppButtonsPreferenceController(SettingsActivity activity, Fragment fragment,
        ...
        /* SPRD: 737412, add whilte list for can not kill app @{ */
        mkeepApps = mActivity.getResources().getStringArray(R.array.cannot_kill_app);
        /* @} */
    ...
    void updateForceStopButton() {
        if (mDpm.packageHasActiveAdmins(mPackageInfo.packageName)) {
            ...
            try{
                String[] exceptions = mContext.getResources().getStringArray(R.array.cannot_force_stop_app);
    ...
    private void showDialogInner(@ButtonActionDialogFragment.DialogType int id) {
        ...
        /*SPRD Bug: 844790 Crashed : can't perform this action after onSaveInstanceState.*/
        newFragment.showAllowingStateLoss(mActivity.getFragmentManager(), "dialog " + id);
    }
