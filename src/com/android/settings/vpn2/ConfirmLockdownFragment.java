...
public class ConfirmLockdownFragment extends InstrumentedDialogFragment
    ...
    private static ConfigDialogFragment mConfigDialogFragment = null;
    ...
    public static void show(Fragment parent, boolean replacing, boolean alwaysOn,
        ...
        mConfigDialogFragment = (ConfigDialogFragment) parent.getFragmentManager().findFragmentByTag(TAG_CONFIG_DIALOG);
    ...
    public void onClick(DialogInterface dialog, int which) {
        ...
        } else if (mConfigDialogFragment != null) {
            ((ConfirmLockdownListener) mConfigDialogFragment).onConfirmLockdown(
                    getArguments().getParcelable(ARG_OPTIONS),
                    getArguments().getBoolean(ARG_ALWAYS_ON),
                    getArguments().getBoolean(ARG_LOCKDOWN_DST));
        }
