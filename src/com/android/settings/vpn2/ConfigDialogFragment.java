...
public class ConfigDialogFragment extends InstrumentedDialogFragment implements
    ...
    public static void show(VpnSettings parent, VpnProfile profile, boolean edit, boolean exists) {
        ...
        frag.showAllowingStateLoss(parent.getFragmentManager(), TAG_CONFIG_DIALOG);
    }
    ...
    public void onShow(DialogInterface dialogInterface) {
        if (getDialog() == null) {
            Log.e(TAG, "dialog is null, maybe fragment has puased before?");
            return;
        }
    ...
    public void onClick(DialogInterface dialogInterface, int button) {
        ...
        if (dialog == null) {
            Log.e(TAG, "dialog is null, maybe fragment has puased before? button = "+button);
            return;
        }
        ...
        if (button == DialogInterface.BUTTON_POSITIVE) {
            ...
            try {
                ...
                if (shouldConnect && !isConnected(profile) &&
                    ...
                    ConfirmLockdownFragment.show(getTargetFragment(), replace, /* alwaysOn */ shouldLockdown,
