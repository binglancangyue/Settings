...
public class PrivateVolumeSettings extends SettingsPreferenceFragment {
    ...
    public void onPrepareOptionsMenu(Menu menu) {
        ...
        /* SPRD: add for storage manage, if this volume is not primary emulated volume, migrate data is visible. {@ */
        final VolumeInfo privateVol = ((PackageManagerEx)(getActivity().getPackageManager()))
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.storage_free:
                ...
                /*SPRD modified for Bug780983, not need to startActivity if StorageManager application is disabled @{ */
