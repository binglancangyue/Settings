...
import android.hardware.usb.UsbManagerEx;
...
public class UsbBackend {
    ...
    public static final int MODE_DATA_MASS_STORAGE   = 0x05 << 1;
    /* Bug713799 end @} */
    ...
    public int getUsbDataMode() {
        ...
        /* SPRD:Add for bug713799 Add sprd udb new UI for usb settings @{*/
        } else if (mUsbManager.isFunctionEnabled(UsbManagerEx.USB_FUNCTION_CDROM)) {
            return MODE_DATA_CDROM;
        } else if (mUsbManager.isFunctionEnabled(UsbManagerEx.USB_FUNCTION_MASS_STORAGE)) {
    ...
    private void setUsbFunction(int mode) {
        switch (mode) {
            ...
            case MODE_DATA_MIDI:
                ...
                break;
            /* SPRD:Add for bug740694 Add sprd udb new UI for usb settings @{*/
            case MODE_DATA_NONE:
                mUsbManager.setCurrentFunction(UsbManager.USB_FUNCTION_NONE, true);
                break;
            case MODE_DATA_CDROM:
                mUsbManager.setCurrentFunction(UsbManagerEx.USB_FUNCTION_CDROM, true);
                break;
