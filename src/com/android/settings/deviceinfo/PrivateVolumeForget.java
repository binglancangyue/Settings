...
public class PrivateVolumeForget extends SettingsPreferenceFragment {
    ...
    public static class ForgetConfirmFragment extends InstrumentedDialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            /* SPRD modified for Bug729876 Settings crash when click Forget button @{ */
            if (record != null) {
            ...
            builder.setPositiveButton(R.string.storage_menu_forget,
                ...
                public void onClick(DialogInterface dialog, int which) {
                    /*SPRD modified for Bug723492, Rename sdcard after forget volume operation cause settings crash {@ */
    ...
    /* SPRD added for Bug723492, Rename sdcard after forget volume operation cause settings crash {@ */
