...
public class SimStatus extends SettingsPreferenceFragment {
    ...
    private void updateNetworkType() {
        ...
        final int actualVoiceNetworkType = mTelephonyManager.getVoiceNetworkType(
                mSir.getSubscriptionId());
        /* SPRD: modify by BUG 734941 @{ */
        final String SYSTEMUI_PACKAGE_CONTEXT = "com.android.systemui";
        final String CONFIG_SHOW4GFORLTE = "config_show4GForLTE";
        ...
        try {
            /* SPRD: modify by BUG 734941 @{ */
            if (getActivity() != null) {
                Context con = getActivity().createPackageContext(SYSTEMUI_PACKAGE_CONTEXT, 0);
                int id = con.getResources().getIdentifier(CONFIG_SHOW4GFORLTE,
                        BOOL, SYSTEMUI_PACKAGE_CONTEXT);
    ...
    private void updateServiceState(ServiceState serviceState) {
        ...
        // SPRD: [bug722350] Just show UNKNOWN when in no service.
        setSummaryText(KEY_OPERATOR_NAME, state == ServiceState.STATE_OUT_OF_SERVICE ? null
    ...
    private void updatePreference() {
        ...
        // SPRD added for Bug713221, "+" should be on the left side of the phone number when forcing RTL layout direction  {@
        // "\u200e" means from left to right
        final String LRM = "\u200e";
        String formattedNumber = DeviceInfoUtils.getFormattedPhoneNumber(getContext(), mSir);
        if (TextUtils.isEmpty(formattedNumber)) {
            setSummaryText(KEY_PHONE_NUMBER, formattedNumber);
        } else {
            setSummaryText(KEY_PHONE_NUMBER, LRM + formattedNumber);
        }
        // @}
    ...
    private OnTabChangeListener mTabListener = new OnTabChangeListener() {
        ...
        public void onTabChanged(String tabId) {
            ...
            mSir = mSelectableSubInfos.get(mCurrentTab);
            /* @} */
