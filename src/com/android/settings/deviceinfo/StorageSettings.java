...
public class StorageSettings extends SettingsPreferenceFragment implements Indexable {
        ...
        if (pref instanceof StorageVolumePreference) {
            ...
            if (vol.getType() == VolumeInfo.TYPE_PRIVATE) {
                ...
                if (VolumeInfo.ID_PRIVATE_INTERNAL.equals(vol.getId())) {
                    ...
                    /* SPRD removed for Bug723203, not process sdcard size by roundStorageSize, show the real size @{
                ...
                /* SPRD: Bug 716231 show toast if no permission to access public storage */
                if ( UserHandle.myUserId() != vol.getMountUserId() ) {
                    Toast.makeText(getActivity(),getActivity().getString(R.string.public_volumes_permission),
    ...
    public static class UnmountTask extends AsyncTask<Void, Void, Exception> {
        ...
        protected Exception doInBackground(Void... params) {
            try {
                /* SPRD 828248 : don't umount if in monkey test @{ */
    ...
    private static class SummaryProvider implements SummaryLoader.SummaryProvider {
        ...
        private void updateSummary() {
            ...
            mLoader.setSummary(this, mContext.getString(R.string.storage_summary_with_sdcard,
