...
public class DashboardSummary extends InstrumentedFragment
    ...
    public void onPause() {
        ...
        /* @{SPRD add for Bug:727583 native crash when device orientation is changed */
    ...
    void rebuildUI() {
        if (!mSuggestionFeatureProvider.isSuggestionEnabled(getContext())) {
            ...
            /* Sprd Bug:772276 enter Settings, and happens splash screen */
            updateCategoryAndSuggestion(null /* tiles */);
    ...
    void updateCategoryAndSuggestion(List<Tile> suggestions) {
        ...
        /* SPRD: Add for Bug 712233 , not call setCategoriesAndSuggestions/setCategory if categories is null. @{ */
        if (category == null) {
            return;
        }
        /* @} */
