...
abstract class BluetoothNameDialogFragment extends InstrumentedDialogFragment
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            mDeviceName = savedInstanceState.getString(KEY_NAME, mDeviceName);
            mDeviceNameEdited = savedInstanceState.getBoolean(KEY_NAME_EDITED, false);
        }

        LayoutInflater inflater = LayoutInflater.from(getActivity());
        View titleView = inflater.inflate(R.layout.bluetooth_rename_title, null);
        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity())
                .setTitle(getDialogTitle())
                .setView(createDialogView(mDeviceName != null ? mDeviceName : ""))
                .setPositiveButton(R.string.bluetooth_rename_button, (dialog, which) -> {
                    String deviceName = (mDeviceNameView == null) ? mDeviceName : mDeviceNameView.getText().toString();
    ...
    public void onDestroy() {
        ...
        mOkButton = null;
        if (sPreference != null) {
            sPreference.setSelectable(true);
        }
    }
    ...
    public void onResume() {
        ...
        if (mOkButton == null) {
            ...
            mOkButton.setEnabled(mDeviceNameEdited && mDeviceName.trim().length() != 0);    // Ok button enabled after user edits
        }
    }
