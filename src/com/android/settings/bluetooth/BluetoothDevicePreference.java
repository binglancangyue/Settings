...
public final class BluetoothDevicePreference extends GearPreference implements
    ...
    private SettingsPreferenceFragment mDeviceListPreferenceFragment;
    /* Talk-back descriptions for various BT icons */
    Resources mResources;

    public BluetoothDevicePreference(Context context, CachedBluetoothDevice cachedDevice,
                                     SettingsPreferenceFragment deviceListPreferenceFragment) {
        super(context, null);
    ...
    public void onDeviceAttributesChanged() {
        ...
        boolean shouldShowDeviceWithoutNames = false;
        if (mDeviceListPreferenceFragment instanceof DeviceListPreferenceFragment) {
            shouldShowDeviceWithoutNames = ((DeviceListPreferenceFragment) mDeviceListPreferenceFragment).shouldShowDevicesWithoutNames();
        } else if (mDeviceListPreferenceFragment instanceof DeviceListPreferenceSprdFragment) {
            shouldShowDeviceWithoutNames = ((DeviceListPreferenceSprdFragment) mDeviceListPreferenceFragment).shouldShowDevicesWithoutNames();
        }
        setVisible(shouldShowDeviceWithoutNames || mCachedDevice.hasHumanReadableName());
