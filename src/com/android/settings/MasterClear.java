...
public class MasterClear extends OptionsMenuFragment {
    ...
    private static final String DIALOG_IS_SHOW = "isShow";
    ...
    private void loadAccountList(final UserManager um) {
        ...
        for (int profileIndex = 0; profileIndex < profilesSize; profileIndex++) {
            ...
            if (AppCloneUserInfo.isAppCloneUserId(profileId)) {
                continue;
            }
            ...
            for (int i = 0; i < N; i++) {
                ...
                /* SPRD 711754 judge the account type, if user is from the resource read, change string @{ */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (savedInstanceState != null) {
            mIsDialogShow = savedInstanceState.getBoolean(DIALOG_IS_SHOW, false);
        }
    ...
    /*SPRD added for bug 692488 @{ */
    @Override
    public void onSaveInstanceState(Bundle outState) {
               outState.putBoolean(DIALOG_IS_SHOW, mIsDialogShow);
