...
public class DateTimeSettings extends DashboardFragment implements
    ...
    protected int getPreferenceScreenResId() {
        ...
        if (GPSHelper.getInstance().isSupportCmcc()) {
            if (GPS_SUPPORT) {
    ...
    protected List<AbstractPreferenceController> getPreferenceControllers(Context context) {
        ...
        //SPRD: Bug#692739 support GPS automatic update time BEG -->
        boolean isSupportCmcc = GPSHelper.getInstance().isSupportCmcc();
    ...
    public Dialog onCreateDialog(int id) {
        switch (id) {
            ...
            //SPRD: Bug#692739 support GPS automatic update time BEG -->
            case SprdAutoTimePreferenceController.DIALOG_GPS_CONFIRM:
                return getPreferenceController(SprdAutoTimePreferenceController.class)
    ...
    public int getDialogMetricsCategory(int dialogId) {
        switch (dialogId) {
            ...
            //SPRD: Bug#692739 support GPS automatic update time BEG -->
            case SprdAutoTimePreferenceController.DIALOG_GPS_CONFIRM:
                int value = MetricsEvent.DIALOG_GPS_CONFIRM;
                return MetricsEvent.DIALOG_GPS_CONFIRM;
            //<-- support GPS automatic update time END
            default:
                return 0;
        }
    ...
    public void showGpsConfirm() {
        removeDialog(SprdAutoTimePreferenceController.DIALOG_GPS_CONFIRM);
        showDialog(SprdAutoTimePreferenceController.DIALOG_GPS_CONFIRM);
    }
    //<-- support GPS automatic update time END
