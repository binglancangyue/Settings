...
import com.android.settings.PreferencesFromResourceXMLUtilsForSettings;
...
public abstract class SettingsPreferenceFragment extends InstrumentedPreferenceFragment
    ...
    private void checkAvailablePrefs(PreferenceGroup preferenceGroup) {
        ...
        for (int i = 0; i < preferenceGroup.getPreferenceCount(); i++) {
            ...
            } else if (PreferencesFromResourceXMLUtilsForSettings.isBackupDisabled(pref,getContext())) {
                //SPRD 709047 hide the preference of backup of non gms version
                preferenceGroup.removePreference(pref);
            }
        }
    }
    ...
    public void highlightPreferenceIfNeeded() {
        if (isAdded() && !mPreferenceHighlighted &&!TextUtils.isEmpty(mPreferenceKey)) {
            final int position = canUseListViewForHighLighting(mPreferenceKey);
            if (position < 0) {
                return;
            }
    ...
    protected void showDialog(int dialogId) {
        ...
        /* SPRD: add for bug709382 @{ */
        if ((getHost() == null)
                || ((getChildFragmentManager() != null)
                && getChildFragmentManager().isDestroyed())) {
            Log.w(TAG, "showDialog: Activity has been destroyed");
            return;
        }
        /* @} */
        /*SPRD Bug: 856450 Crashed : can't perform this action after onSaveInstanceState.@{*/
        mDialogFragment.showAllowingStateLoss(getChildFragmentManager(), Integer.toString(dialogId));
        /* @} */
    }
    ...
    public static class HighlightablePreferenceGroupAdapter extends PreferenceGroupAdapter {
        ...
        private boolean mIsOnBind = false;//SPRD for Bug 748218
        ...
        public void highlight(int position) {
            ...
            /* SPRD: Bug 748218 control time sequence for notifyDataSetChanged()@{ */
            if (!mIsOnBind) {
        ...
        public void onBindViewHolder(PreferenceViewHolder holder, int position) {
            mIsOnBind = true;//SPRD for Bug 748218
            ...
            mIsOnBind = false;//SPRD for Bug 748218
        }
    }
}
