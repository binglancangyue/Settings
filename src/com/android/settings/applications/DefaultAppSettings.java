...
public class DefaultAppSettings extends DashboardFragment {
    ...
    private static List<AbstractPreferenceController> buildPreferenceControllers(Context context) {
         ...
         *@{
         */
        controllers.add(new DefaultCameraPreferenceController(context));
        controllers.add(new DefaultGalleryPreferenceController(context));
        controllers.add(new DefaultMusicPreferenceController(context));
        controllers.add(new DefaultEmailPreferenceController(context));
        /*@}*/
        return controllers;
    }
    ...
    static class SummaryProvider implements SummaryLoader.SummaryProvider {
         ...
         *@{
         */
        private final DefaultCameraPreferenceController mDefaultCameraPreferenceController;
        private final DefaultGalleryPreferenceController mDefaultGalleryPreferenceController;
        private final DefaultMusicPreferenceController mDefaultMusicPreferenceController;
        private final DefaultEmailPreferenceController mDefaultEmailPreferenceController;
        /*@}*/
        ...
        public SummaryProvider(Context context, SummaryLoader summaryLoader) {
             ...
             *@{
             */
            mDefaultCameraPreferenceController = new DefaultCameraPreferenceController(mContext);
            mDefaultGalleryPreferenceController = new DefaultGalleryPreferenceController(mContext);
            mDefaultMusicPreferenceController = new DefaultMusicPreferenceController(mContext);
            mDefaultEmailPreferenceController = new DefaultEmailPreferenceController(mContext);
            /*@}*/
        }
        ...
        public void setListening(boolean listening) {
             ...
             */
            summary = concatSummaryText(summary,
                mDefaultCameraPreferenceController.getDefaultAppLabel());
            summary = concatSummaryText(summary,
                mDefaultEmailPreferenceController.getDefaultAppLabel());
            summary = concatSummaryText(summary,
                mDefaultGalleryPreferenceController.getDefaultAppLabel());
            summary = concatSummaryText(summary,
                mDefaultMusicPreferenceController.getDefaultAppLabel());
            /*@}*/
