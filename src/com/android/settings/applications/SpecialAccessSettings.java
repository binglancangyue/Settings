...
public class SpecialAccessSettings extends DashboardFragment {
    ...
    private static final String[] DISABLED_FEATURES_LOW_RAM =
            new String[]{"notification_access", "zen_access", "enabled_vr_listeners",
                    "picture_in_picture"};
    private static final String KEY_POWER_APPS= "high_power_apps";
    ...
    public void onCreate(Bundle icicle) {
        ...
        /*SPRD: 843493 remove google original battery optimization if Battery Saver Mode is supported@{*/
        if (1 == SystemProperties.getInt("persist.sys.pwctl.enable", 1)) {
            removePreference(KEY_POWER_APPS);
        }
        /*@}*/
