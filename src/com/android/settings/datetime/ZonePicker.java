...
public class ZonePicker extends ListFragment implements Instrumentable {
    ...
    public static SimpleAdapter constructTimezoneAdapter(Context context,
        ...
        //SPRD 713372 not sort by language of chinesse
        final MyComparator comparator = new MyComparator(sortKey,context);
    ...
    private static class MyComparator implements Comparator<Map<?, ?>> {
        ...
        //SPRD 713372 not sort by language of chinesse
        public MyComparator(String sortingKey,Context context) {
            mSortingKey = sortingKey;
            mContext = context;
            mCollator = Collator.getInstance(mContext.getResources().getConfiguration().locale.getLanguage().equals("zh")?Locale.CHINA:mContext.getResources().getConfiguration().locale);
        }
