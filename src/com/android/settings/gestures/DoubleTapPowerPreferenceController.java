...
public class DoubleTapPowerPreferenceController extends GesturePreferenceController {
    ...
    public ResultPayload getResultPayload() {
        final Intent intent = DatabaseIndexingUtils.buildSubsettingIntent(mContext,
                ...
                mContext.getString(R.string.double_tap_power_for_camera_title));
    ...
    /**
     * facelock enabled
     * @return true if current face lock feature enabled
     */
    private boolean isFaceLockEnable() {
        FaceManager faceManager = (FaceManager) mContext.getSystemService(Context.FACE_SERVICE);
        return faceManager != null && faceManager.isHardwareDetected() && faceManager.getEnrolledFaces().size() > 0
