...
public class LanguageAndInputSettings extends DashboardFragment {
    ...
    /* SPRD:Bug 732318 change the title "Languages & input" language after change the system language @{ */
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstState) {
       final View result = super.onCreateView(inflater, container, savedInstState);

       getActivity().setTitle(R.string.language_keyboard_settings_title);
