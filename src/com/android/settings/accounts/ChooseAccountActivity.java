...
public class ChooseAccountActivity extends SettingsPreferenceFragment {
    ...
    private void updateAuthDescriptions() {
        ...
        for (int i = 0; i < mAuthDescs.length; i++) {
            if (mAuthDescs[i].type.startsWith("sprd")) {
                continue;
            }
    ...
    private void onAuthDescriptionsUpdated() {
        ...
        if (mProviderList.size() == 1) {
            ...
            //SPRD added for bug 720313, need to pop a toast ro remind users that no availiable acocount
    ...
    protected CharSequence getLabelForType(final String accountType) {
        ...
        if (mTypeToAuthDescription.containsKey(accountType)) {
            ...
            /* SPRD: added for #709450 @{ */
            if (accountType.equalsIgnoreCase(EMAIL_PACKAGE_NAME)) {
                label = getString(R.string.header_category_personal);
                return label;
            }
            /* @} */
            try {
