...
public class AccessibilitySettings extends SettingsPreferenceFragment implements
    ...
    private void updateSystemPreferences() {
        ...
        if (SystemProperties.getBoolean("ro.product.assistanttouch",true) && UserHandle.myUserId() == UserHandle.USER_OWNER) {
            ...
            //mAssistantPreferenceScreen = (PreferenceScreen) findPreference(ASSISTANT_PREFERENCE_SCREEN);
        }
        /*@}*/
    ...
    public static final SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
        ...
        public List<String> getNonIndexableKeys(Context context) {
            ...
            /* @{ SPRD Bug:673135, Under Guest mode, can not search accessibility, caused by Bug:598664 */
            if (UserHandle.myUserId() != UserHandle.USER_OWNER){
                keys.add(ASSISTANT_PREFERENCE_SCREEN);
                }
            /*@}*/
