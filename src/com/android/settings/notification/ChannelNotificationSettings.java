...
public class ChannelNotificationSettings extends NotificationSettingsBase {
    ...
    private void setupRingtone() {
        ...
        /* SPRD: modify by BUG 742584 @{ */
        Uri defaultRingtoneUri = Settings.System.DEFAULT_NOTIFICATION_URI;
        if (!isRingtoneFileExist(mChannel.getSound())) {
            Log.d(TAG, "Ringtone file isn't exist, set to default ringtone");
            mChannel.setSound(defaultRingtoneUri, mChannel.getAudioAttributes());
    ...
    void updateDependents(boolean banned) {
        ...
        setVisible(parent, mBadge, checkCanBeVisible(NotificationManager.IMPORTANCE_MIN) && canBadging());
