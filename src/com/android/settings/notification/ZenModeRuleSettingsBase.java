...
public abstract class ZenModeRuleSettingsBase extends ZenModeSettingsBase
    ...
    abstract protected void onCreateInternal(Bundle savedInstanceState);
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (mId == null) {
            Log.w(TAG, "The EXTRA_RULE_ID is Null");
            toastAndFinish();
            return;
        }
    ...
    private void toastAndFinish() {
        //SPRD 709582 null pointer exception
        if(getActivity() == null) {
            return;
        }
        if (!mDeleting) {
