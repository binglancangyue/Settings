...
public class ZenModeScheduleRuleSettings extends ZenModeRuleSettingsBase {
    ...
    private static final String DAY_DIALOG = "day_dialog";
    ...
    protected void onCreateInternal(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null && savedInstanceState.getBoolean(DAY_DIALOG)) {
            showDaysDialog();
        }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putBoolean(DAY_DIALOG, (mDayDialog != null && mDayDialog.isShowing()));
    }
    ...
    private static class TimePickerPreference extends Preference {
        ...
        public static class TimePickerFragment extends InstrumentedDialogFragment implements
            ...
            public static TimePickerPreference pref;
