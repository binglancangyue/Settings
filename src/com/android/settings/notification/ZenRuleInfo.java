...
public class ZenRuleInfo implements Serializable {
    @Override
    ...
    public transient ComponentName configurationActivity;
    public transient Uri defaultConditionId;
    public transient ComponentName serviceComponent;
