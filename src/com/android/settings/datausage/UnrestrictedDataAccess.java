...
public class UnrestrictedDataAccess extends SettingsPreferenceFragment
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference instanceof AccessPreference) {
            ...
            /* SPRD Bug:747898, monkey test, and happens javaCrash */
    ...
    private class AccessPreference extends SwitchPreference implements DataSaverBackend.Listener {
        ...
        public AccessPreference(final Context context, AppEntry entry) {
            super(context);
            mEntry = entry;
            /* SPRD Bug:760376 monkey test, and happens ClassCastException */
            if (mEntry.extraInfo instanceof DataUsageState) {
        ...
        protected void onClick() {
            /* SPRD Bug:744007 monkey test, and happen nullPointerException */
