...
public class BillingCycleSettings extends DataUsageBase implements
    ...
    private void updatePrefs() {
        /* SPRD Bug:758464 BillingCycleSettings happens crash when set billing */
        if (!isAdded()) {
            return;
        }
    ...
    public static class CycleEditorFragment extends InstrumentedDialogFragment implements
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            final NetworkTemplate template = getArguments().getParcelable(EXTRA_TEMPLATE);
            /* SPRD added for bug:711152 @{ */
            int cycleDay = editor.getPolicyCycleDay(template);
            if ((savedInstanceState != null) && (savedInstanceState.getInt("pickerValue", -1) != -1)) {
                cycleDay = savedInstanceState.getInt("pickerValue");
            }
            /* }@ */
        ...
        public void onSaveInstanceState(Bundle pickerState) {
            pickerState.putInt("pickerValue", mCycleDayPicker.getValue());
        }
        /* }@ */
    }
