...
import com.android.settings.bluetooth.BluetoothSettingsSprd;
...
import com.android.settings.fuelgauge.SprdPowerUsageSummary;
...
import com.android.settings.location.LocationAgpsEnableConfig;
...
public final class SearchIndexableResources {
    ...
    static {
        ...
        addIndex(BluetoothSettingsSprd.class, NO_DATA_RES_ID, R.drawable.ic_settings_bluetooth);
        ...
        if (!DisableDataUsage.getInstance().isCmcc()) {
        ...
        //SPRD 708767 removed google soundsettings
        ...
        /*SPRD 734194:  add Battery Saver @{*/
        //addIndex(PowerUsageSummary.class,
        //        R.xml.power_usage_summary, R.drawable.ic_settings_battery);
        addIndex(SprdPowerUsageSummary.class,
        ...
        /*SPRD 751064: removed google BatterySaverSettings @{
         ...
         *@{
         */
        addIndex(SmartControlsSettings.class, NO_DATA_RES_ID,
                R.drawable.ic_settings_smart_controls);
        /*@}*/
        /* SPRD 692453 ,add the search for dynamic navigationbar @{ */
        addIndex(NavigationBarSettings.class, NO_DATA_RES_ID,
                R.drawable.ic_settings_navigation_bar);
        /*@}*/

        //SPRD: Bug#692740 support AGPS settings BEG -->
        if (GPSHelper.getInstance().isSupportCmcc() && !Utils.WCN_DISABLED) {
            addIndex(LocationAgpsEnableConfig.class, R.xml.agps_enable_config, R.drawable.ic_settings_location);
        }
