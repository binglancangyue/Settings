...
public class DatabaseIndexingManager {
    ...
    // SPRD added for Bug715766, In guest mode, simlock should not be searched
    private static final String AUDIO_PROFILE_AUTHORITY = "com.sprd.audioprofile";
    ...
    void updateDatabase(boolean needsReindexing, String localeStr) {
        ...
        //fix for bug 812102
            ...
            Log.e(LOG_TAG, "updateDataInDatabase error", ex);
        } finally {
            try {
                database.endTransaction();
            //fix for bug 807724
            } catch (Exception e) {
                Log.e(LOG_TAG, "Cannot endTransaction database!", e);
            }
        }
    }
    ...
    void updateDataInDatabase(SQLiteDatabase database,
        ...
        try {
            Log.d(LOG_TAG, "updateDataInDatabase enabledResults start");
            ...
            Log.d(LOG_TAG, "updateDataInDatabase enabledResults end");
        ...
        try {
            Log.d(LOG_TAG, "updateDataInDatabase disabledResults start");
            ...
            Log.d(LOG_TAG, "updateDataInDatabase disabledResults end");
    ...
    void addNonIndexablesKeysFromRemoteProvider(String packageName,
        ...
        // SPRD added for Bug715766, In guest mode, simlock should not be searched
        if (AUDIO_PROFILE_AUTHORITY.equals(authority)) {
            addNonIndexableKeys(authority, keys);
        } else {
