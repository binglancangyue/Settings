...
public class IntentSearchViewHolder extends SearchViewHolder {
    ...
    public void onBind(final SearchFragment fragment, final SearchResult result) {
        ...
        itemView.setOnClickListener(v -> {
            ...
            //SPRD 692516 porting AudioProfile
            if(cn != null && ("com.sprd.audioprofile").equals(cn.getPackageName()) &&
                ("com.sprd.audioprofile.AudioProfileSettings").equals(cn.getClassName())) {
                intent.setAction("com.sprd.action.AUDIO_PROFILE");
