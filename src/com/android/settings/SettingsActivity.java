...
import com.android.settings.wifi.WifiPickerActivity;
import com.android.settings.widget.ScanBar;
import com.android.settings.wifi.CmccAdvancedWifiSettings;
...
import com.sprd.settings.wifi.HotspotSettings;
...
public class SettingsActivity extends SettingsDrawerActivity
    ...
    private boolean mIsSubsidyLocked = false;
    private static SettingsActivity mSettingsActivity = null;
    ...
    public boolean isSubsidyLocked() {
        return mIsSubsidyLocked;
    }
    ...
    protected void onCreate(Bundle savedState) {
        ...
        mIsSubsidyLocked = intent.getBooleanExtra(IS_SUBSIDYLOCK,false);
        mStatusBarManager = (StatusBarManager) getSystemService(Context.STATUS_BAR_SERVICE);
//        if (intent.getBooleanExtra(EXTRA_HIDE_DRAWER, false) || mIsSubsidyLocked) {
...
//        }
    ...
    protected void onStop() {
        ...
        //add for bug810725 monkey test of settings caused anr
    ...
    private void doUpdateTilesList() {
        ...
        //        pm.hasSystemFeature(PackageManager.FEATURE_WIFI), isAdmin) || somethingChanged;
                (pm.hasSystemFeature(PackageManager.FEATURE_WIFI) && !Utils.WCN_DISABLED), isAdmin) || somethingChanged;

        somethingChanged = setTileEnabled(new ComponentName(packageName,
                        Settings.BluetoothSettingsActivity.class.getName()),
        //        pm.hasSystemFeature(PackageManager.FEATURE_BLUETOOTH), isAdmin)
                (pm.hasSystemFeature(PackageManager.FEATURE_BLUETOOTH) && !Utils.WCN_DISABLED), isAdmin)
                || somethingChanged;
        ...
        /*SPRD added for bug 692494,hide the datausage n cmcc version @{*/
        ...
        somethingChanged = setTileEnabled(
                new ComponentName(packageName,
                        isDataPlanFeatureEnabled
                                ? Settings.DataPlanUsageSummaryActivity.class.getName()
                                : Settings.DataUsageSummaryActivity.class.getName()),
                Utils.isBandwidthControlEnabled() && isDataUsageEnabled /* enabled */,
                isAdmin) || somethingChanged;
...
/*        somethingChanged = setTileEnabled(new ComponentName(packageName,
        ...
        setTileEnabled(new ComponentName(packageName,
                Settings.AccessibilitySettingsActivity.class.getName()), false, isAdmin);

        setTileEnabled(new ComponentName(packageName,
                Settings.UserAndAccountDashboardActivity.class.getName()), false, isAdmin);
        ...
        setTileEnabled(new ComponentName(packageName,
                Settings.DisplaySettingsActivity.class.getName()), false, isAdmin);
        ...
        /* SPRD 692453 ,add the search for dynamic navigationbar @{ */
        /*SPRD bug 714724:Display nav setting in ower only*/
        boolean qemuEnabled = "0".equals(android.os.SystemProperties.get("qemu.hw.mainkeys"));
        boolean supportDynaNaviBar = DynaNavigationBarPluginsUtils.getInstance(this).isSupportDynaNaviBar();
        setTileEnabled(new ComponentName(packageName,NavigationBarSettings.class.getName()), qemuEnabled && supportDynaNaviBar
                && ActivityManager.getCurrentUser() == UserHandle.USER_OWNER, isAdmin);
        /* @} */
    ...
    /* SPRD: 708278 only handles KEYCODE_SEARCH key event@{*/
    @Override
