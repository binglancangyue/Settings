...
public class TextToSpeechSettings extends SettingsPreferenceFragment
    ...
    public void onResume() {
        ...
        /* SPRD: Add for bug 712632 enter TTS output, stop pico tts, click pico TTS,setting stop @{ */
        if (mTts.getDefaultEngine() == null) {
            Preference enginePreference = findPreference(KEY_TTS_ENGINE_PREFERENCE);
            ((GearPreference) enginePreference).setOnGearClickListener(null);
            enginePreference.setSummary(null);
            mLocalePreference.setEnabled(false);
            return;
        }
        /* @} */
