...
import com.android.settings.display.TouchLightTimeoutPreferenceController;
...
public class DisplaySettings extends DashboardFragment {
 ...
 //       controllers.add(new AutoBrightnessPreferenceController(context, KEY_AUTO_BRIGHTNESS));
         ...
         *@{
         */
        controllers.add(new TouchLightTimeoutPreferenceController(context));
        /*@}*/
        return controllers;
    }
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        ScreenZoomPreference preference = (ScreenZoomPreference)findPreference(KEY_DISPLAY_SIZE);
