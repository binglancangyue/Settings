...
public class FaceIdSettings extends SubSettings {
    ...
    public static class FaceIdSettingsFragment extends SettingsPreferenceFragment
        ...
        private static final String FACEID_LIVENESS_MODE_PROP = "persist.sys.faceid.livenessmode";
        ...
        private PreferenceScreen createPreferenceHierarchy() {
            ...
            mFaceIdLivenessModeSwitch.setChecked(SystemProperties.getBoolean(FACEID_LIVENESS_MODE_PROP, false));
        ...
        public boolean onPreferenceChange(Preference preference, Object value) {
            ...
            if (KEY_FACEID_ENABLE_KEYGUARD_TOGGLE.equals(key)) {
                ...
                Log.d(TAG, "sprd_facelock onpreferenceChange()  KEY_FACEID_SETTINGS value = " + (Boolean) value);
                if ((Boolean) value) {
                    SystemProperties.set(FACEID_LIVENESS_MODE_PROP, "1");
                } else {
                    SystemProperties.set(FACEID_LIVENESS_MODE_PROP, "0");
                }
            } else {
        ...
        private void launchChooseOrConfirmLock() {
            Intent intent = new Intent();
            long challenge = -1;//mFaceManager.preEnroll();
