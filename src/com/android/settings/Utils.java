...
public final class Utils extends com.android.settingslib.Utils {
    ...
    public static final boolean WCN_DISABLED = SystemProperties.get("ro.wcn").equals("disabled");
    ...
    private static final String PACKAGE_REMOVED_BY_MOVE_STORAGE = "package_removed_by_move_storage";
   ...
   /**
    * SPRD added for Bug780983, This method is used to check whether an intent can be resolved
    */
   ...
   /* SPRD added for bug816793, if package removed by manual,should remove task @{ */
   public static boolean isPackageRemovedByMoveStorage(Context context) {
       return Settings.System.getInt(context.getContentResolver(),
           PACKAGE_REMOVED_BY_MOVE_STORAGE, 0) != 0;
   }

   public static void updatePackageRemovedByMoveStorage(Context context, boolean byMoveStorage) {
       if (byMoveStorage) {
           Settings.System.putInt(context.getContentResolver(),
               PACKAGE_REMOVED_BY_MOVE_STORAGE, 1);
       } else {
           Settings.System.putInt(context.getContentResolver(),
               PACKAGE_REMOVED_BY_MOVE_STORAGE, 0);
       }
   }
   /* @} */
