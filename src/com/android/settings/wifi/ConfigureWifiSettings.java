...
public class ConfigureWifiSettings extends DashboardFragment {
    ...
    protected int getPreferenceScreenResId() {
        if(supportCMCC) {
            return R.xml.wifi_configure_settings_cmcc;
        } else {
    ...
    protected List<AbstractPreferenceController> getPreferenceControllers(Context context) {
        ...
        if(supportCMCC) {
            controllers.add(new CmccAdvancedWifiPreferenceController(context, getLifecycle(), wifiManager));
        }
        ...
        controllers.add(new BgscanRoamingPreferenceController(context, getLifecycle()));
        return controllers;
    }
