...
public class WifiApDialog extends AlertDialog implements View.OnClickListener,
    ...
    public static final int DEFAULT_LIMIT = SystemProperties.getInt("persist.wifi.softap.reqstanum",SystemProperties.getInt("ro.wifi.softap.maxstanum",8));
