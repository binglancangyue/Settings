...
public class WifiDetailPreferenceController extends AbstractPreferenceController
    ...
    public WifiDetailPreferenceController(
        ...
        mAddonStub = SprdWifiSettingsAddonStub.getInstance(context);
    ...
    public void displayPreference(PreferenceScreen screen) {
        ...
        /* SPRD:Add for bug758473 There is no response when clickliing the cancel button @{ */
        mDisconnectButton = (Button) mButtonsPref.findViewById(R.id.disconnect_button);
        if (supportCMCC) {
            mDisconnectButton.setText(R.string.wifi_disconnect);
            mDisconnectButton.setOnClickListener(view -> disconnectNetwork());
        } else {
        ...
        if (WifiManagerEx.SUPPORT_OPERATOR_VODAFONE_UK.equals(mWifiManagerEx.getOperatorSupport())
                && WifiManagerEx.AUTO_JOIN_SPECIFIC_NETWORK.equals(mAccessPoint.getSsid().toString())) {
            if (mForgetButton != null) {
