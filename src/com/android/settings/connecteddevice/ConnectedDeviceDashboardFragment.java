...
public class ConnectedDeviceDashboardFragment extends DashboardFragment {
    ...
    protected int getPreferenceScreenResId() {
        if (WCN_DISABLED) {
            return R.xml.no_wcn_connected_devices;
        }
            ...
            if (listening) {
                if (mNfcPreferenceController.isAvailable()) {
                    if (mContext.getResources().getBoolean(com.android.internal.R.bool.config_enableWifiDisplay)) {
                        ...
                        mSummaryLoader.setSummary(this,
                                mContext.getString(R.string.connected_devices_dashboard_no_cast_summary));
                    }
                } else {
                    if (mContext.getResources().getBoolean(com.android.internal.R.bool.config_enableWifiDisplay)) {
                        ...
                        mSummaryLoader.setSummary(this, mContext.getString(
                                R.string.connected_devices_dashboard_no_nfc_no_cast_summary));
                    }
                }
            }
        }
