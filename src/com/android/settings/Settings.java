...
public class Settings extends SettingsActivity {
    ...
    */
    ...
    //SPRD: for bug 692495 add the task manager feature for cmcc authentication.
    public static class SprdManageTasksActivity extends RunningServicesActivity { /* empty */ }
    //<-- Add the task manager feature END
    ...
    public static class CmccAdvancedWifiSettingsActivity extends SettingsActivity { /* empty */ }
    ...
    public static class ApnSettingsActivity extends SettingsActivity {
        /* SPRD: bug 730709 under Apn interface, when receive KEYCODE_SEARCH event happens crash @{ */
        @Override
    ...
    public static class ImeiInformationActivity extends SettingsActivity {
        /* SPRD: bug 753488 when receive KEYCODE_SEARCH event happens crash @{ */
        @Override
        public boolean onKeyDown(int keyCode, KeyEvent event) {
            switch (keyCode) {
                case KeyEvent.KEYCODE_SEARCH:
     ...
     * add by lym
     */
    public static class SleepActivity extends SettingsActivity {/* empty */}
