...
public class ChooseLockGeneric extends SettingsActivity {
    ...
    public static class ChooseLockGenericFragment extends SettingsPreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            mForFaceId = getActivity().getIntent().getBooleanExtra(
        ...
        public boolean onPreferenceTreeClick(Preference preference) {
            ...
            /* SPRD: fix for bug 802968 @{ */
            if(!mLockPatternUtils.isSecure(mUserId) && key != null && key.equals(getKeyForCurrent())) {
                Log.d(TAG, "dont need set again");
                finish();
                return true;
            }
            /* @} */
        ...
        private void removeAllFingerprintForUserAndFinish(final int userId) {
            if (mFingerprintManager != null && mFingerprintManager.isHardwareDetected()) {
                if (mFingerprintManager.hasEnrolledFingerprints(userId)) {
                    ...
                    if (SystemProperties.getBoolean("persist.sprd.fp.lockapp", false)) {
