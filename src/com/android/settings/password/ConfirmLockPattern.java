        ...
        private void handleAttemptLockout(long elapsedRealtimeDeadline) {
            ...
            mCountdownTimer = new CountDownTimer(
                ...
                public void onTick(long millisUntilFinished) {
                    ...
                    /* sprdroid Bug853712 '1 seconds' should be '1 second' @{ */
                    String errorText = getString(R.string.lockpattern_too_many_failed_confirmation_attempts, secondsCountdown);
                    if (secondsCountdown <= 1 && errorText.contains("seconds")) {
                        errorText = errorText.replace("seconds", "second");
                    }
