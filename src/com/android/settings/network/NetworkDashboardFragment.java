...
public class NetworkDashboardFragment extends DashboardFragment implements
    ...
    protected int getPreferenceScreenResId() {
        if (Utils.WCN_DISABLED) {
            return R.xml.no_wcn_network_and_internet;
        }
...
//                new WifiMasterSwitchPreferenceController(context, metricsFeatureProvider);
        ...
        if (!Utils.WCN_DISABLED) {
            final WifiMasterSwitchPreferenceController wifiPreferenceController =
                    new WifiMasterSwitchPreferenceController(context, metricsFeatureProvider);
            if (lifecycle != null) lifecycle.addObserver(wifiPreferenceController);
            controllers.add(wifiPreferenceController);
        }
        final NetworkManagerPreferenceController networkManagerpreferenceController =
                new NetworkManagerPreferenceController(context);
        controllers.add(networkManagerpreferenceController);
        return controllers;
    }
        ...
        public void setListening(boolean listening) {
            if (listening) {
                ...
                if (!Customer.IS_KD003) {
                    ...
                    summary = mContext.getString(R.string.network_dashboard_summary_mobile);
                }
