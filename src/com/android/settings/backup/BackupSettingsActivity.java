...
public class BackupSettingsActivity extends Activity implements Indexable {
    ...
    public static final SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider() {
                ...
                public List<String> getNonIndexableKeys(Context context) {
                    ...
                    /* sprd Bug:739824 backup has been removed, so don't show it in search @{*/
    ...
    public static boolean isBackupDisabled(Context context) {
        final String GSETTINGS_PROVIDER = "com.google.settings";
        ...
        try {
            return vendorSpecific || !backupManager.isBackupServiceActive(UserHandle.myUserId());
