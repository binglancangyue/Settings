...
public class HotspotEnabler implements SwitchBar.OnSwitchChangeListener,DataSaverBackend.Listener{
...
@Override
     ...
     */
    /*
    //SPRD: Bug #609342 On android N,the logic of storing and restoring wifi state is in framework BEG-->
    ...
    //<-- On android N,the logic of storing and restoring wifi state is in framework END
    */

    if (isChecked){
       if (mWifiManager.startSoftAp(null)) {
           mSwitch.setEnabled(false);
       }
    } else {
